<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ArtistProfile.aspx.cs" Inherits="ArtistProfile" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
      <div class="innerContent">
        ...
        <asp:Repeater ID="rptr_Profile" runat="server">
            ...
            <ItemTemplate>
                ...
                <div class="profileRight">
                    ...
                    <div class="btnUpdateArtistProfile">
                        <a href="?artist=<%#Eval("artistID") %>" style="color: white;">Update Artist Profile</a>
                    </div>
                </div>
        ...
        <div class="profileFooterButton">
            <div class="pfbLeft">
                <asp:Button ID="btnMyApplications" OnClick="btnMyApplications_Click" runat="server" Text="My Applications" />
